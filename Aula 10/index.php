...
<div class="container">
    ...
    <form action="cadastro_cliente.php" method="POST">
        <ul>
            ...
            <li>Telefone: <input type="text" name="fone" size="20" maxlength="20"></li>
        </ul>
    ...
    <table cellspacing="0" cellpadding="5">
        ...
        <?php 
            ...
            if ($mostrar_clientes->num_rows > 0) {
                while ($row_cli = $mostrar_clientes->fetch_assoc()) {
                    echo "
                        <tr align='center'>
                            ...
                            <td>
                                <form action='alterar_cliente.php' method='GET'>
                ...
                echo "<tr align='center'><td colspan='5'>Nenhum Cliente Registrado</td></tr>";
            }
        ?>
    </table>
